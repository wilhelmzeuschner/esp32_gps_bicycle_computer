...
void on_time_helper(bool create_output)
{
	...
	{
		time_running = zero_padder(String(seconds_running / 3600 - seconds_running % 3600)) + ":" + zero_padder(String(seconds_running / 3600 - (seconds_running / 3600) * 60))) + ":" + zero_padder(String(seconds_running - (seconds_running / 60) * 60));
	}
